<template>
    <div class="box-content">
        <v-card class="mx-auto my-12">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 500 500">
                    <defs>
                        ...
                        <clipPath id="freepik--clip-path-5--inject-3">
                            <path d="M194.8,224.56s-1.15-12.13-7.12-12.51-5.78,8.28-4,14.25,6,7.89,9.43,4.81"
                                style="fill:#407BFF;stroke:#263238;stroke-linecap:round;stroke-linejoin:round;stroke-width:0.75px">
                            </path>
                        </clipPath>
                    ...
                    <g id="freepik--Device--inject-3">
                        ...
                        <ellipse cx="324.72" cy="255.73" rx="11.03" ry="15.2"
                            transform="translate(-64.52 116.69) rotate(-18.56)" style="fill:#263238"></ellipse>
                        <path
                    ...
                    <g id="freepik--Clock--inject-3">
                        ...
                        <path d="M272.23,147.73a2.05,2.05,0,1,1-2.05-2A2.05,2.05,0,0,1,272.23,147.73Z" style="fill:#263238">
                        </path>
                    ...
                    <g id="freepik--file-cabinet--inject-3">
                        ...
                        <rect x="122.67" y="218.16" width="25.37" height="8.46" style="fill:#263238"></rect>
                        <rect x="103.64" y="253.4" width="63.43" height="46.51"
                            style="fill:none;stroke:#263238;stroke-linecap:round;stroke-linejoin:round"></rect>
                        <rect x="122.67" y="272.43" width="25.37" height="8.46" style="fill:#263238"></rect>
                        <rect x="103.64" y="307.66" width="63.43" height="46.51"
                            style="fill:none;stroke:#263238;stroke-linecap:round;stroke-linejoin:round"></rect>
                        <rect x="122.67" y="326.69" width="25.37" height="8.46" style="fill:#263238"></rect>
                    </g>
                    <g id="freepik--Character--inject-3">
                        <g style="clip-path:url(#freepik--clip-path--inject-3)">
                            ...
                            <g style="clip-path:url(#freepik--clip-path-6--inject-3)">
                                <path d="M173,232.65l-10.2,7.51s.57,1.13,4.77,7.16l10.78-6.54Z" style="fill:#407BFF"></path>
            ...
            <a data-v-257b5c3f="" href="https://storyset.com/data" style="
    visibility: hidden;
